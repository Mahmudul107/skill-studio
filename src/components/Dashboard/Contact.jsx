  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="hero min-h-screen">
        <div className="hero-content h-96 flex-col lg:flex-row-reverse bg-white border-red-400">
          <div className="text-center lg:text-left p-8">
          <h2 className="text-4xl font-bold mb-4 text-fuchsia-500 text-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 animate-bounce">Contact Us</h2>

            <div className="divider"></div>
            <p className="text-lg flex items-center gap-2 mb-2"> <FaInbox className="text-fuchsia-500 rounded-full w-5 h-5"/>
              <span className="text-primary">Email:</span>{" "}
              mahmudulislam378@gmail.com
            </p>
            <p className="flex gap-2 items-center text-lg mb-2">
            ...
            <p className="flex gap-2 text-lg">
              ...
              <span className="text-primary">Location:</span> Dhaka,
              Bangladesh
            </p>
          </div>
